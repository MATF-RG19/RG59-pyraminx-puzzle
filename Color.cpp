...
void SetRed() {
	/*Postavljanje materijala za crvenu boju*/
...
void SetGreen() {
	/*Postavljanje materijala za zelenu boju*/
...
void SetBlue() {
	/*Postavljanje materijala za plavu boju*/
...
void SetYellow() {
	/*Postavljanje materijala za zutu boju*/
...
void SetBlack() {
	/*Postavljanje materijala za crnu boju*/
